...
public class QosObserver implements IQosObserver {
	...
	public void tempo2(Calendar date) throws IOException, InterruptedException,
			IOException {
		SimpleDateFormat sdf = new SimpleDateFormat("HHmmssSSS");
		...
		BufferedWriter buffWrite2 = new BufferedWriter(new FileWriter(
				"../qos_timetable.txt", true));
		...
		BufferedWriter buffWrite3 = new BufferedWriter(new FileWriter(
				"../qos_timetable2.txt", true));
		buffWrite3.append(tempoTotal + "\n");
		buffWrite3.close();
	}
}